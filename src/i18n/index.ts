...
const UI: Record<Lang, Record<string, string>> = {
  ko: {
    ...
    'victory.ch3': '고대 용을 물리치고 용의 산맥을 정복했다. 전설이 시작된다.',
  ...
  en: {
    ...
    'map.chapter.sub.3': 'Conquer the Dragon\'s Mountain Range',
    'map.floor': 'Floor {{n}}',
    'battle.turn': 'Turn {{n}}',
    ...
    'victory.ch3': 'Defeated the Ancient Dragon and conquered the Dragon\'s Mountain Range. The legend begins.',
